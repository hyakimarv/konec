...
pridej_zvire(utulek, "Archibald", "morce", 3)
pridej_zvire(utulek, "karel", "medved", 5)
pridej_zvire(utulek, "andy", "kosatka", 7)
pridej_zvire(utulek, "mauricius", "leguan", 2)
pridej_zvire(utulek, "lordstek", "tygr", 6)
pridej_zvire(utulek, "bobanek", "levhart", 6)
